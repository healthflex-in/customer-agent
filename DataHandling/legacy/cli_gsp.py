...
Took inspiration from cli_chat_sr.py, located in the "legacy" directory of the branch.
"""
...
recognizer.pause_threshold = 2.0  # Longer pause threshold for natural conversation
recognizer.energy_threshold = 300  # Adjust to suit your environment
recognizer.non_speaking_duration = 2.0  # Adjust to suit your environment
recognizer.phrase_threshold = 0.0  # Adjust to suit your environment
...
def listen_for_speech(timeout=100, phrase_time_limit=None):
    """
...
def process_user_input(text):
    ...
    # Process the input through HealthAgent
...
def main_interview_loop():
    ...
    try:
        while True:
            ...
            user_text = listen_for_speech(timeout=15)
